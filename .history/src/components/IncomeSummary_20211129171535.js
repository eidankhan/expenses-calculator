...
export const IncomeSummary = () => {
  ...
  return (
    <div className="my-3">
      <div className="row">
        <div className="col-md-4 my-2 "> <strong>Income</strong> </div>
        <div className="col-md-4 my-2 "> <strong>Expense</strong> </div>
        <div className="col-md-4 my-2 "> <strong>Balance</strong> </div>
      </div>
